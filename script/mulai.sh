...
wget -O /etc/nginx/nginx.conf "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/nginx.conf"
mkdir -p /home/vps/public_html
echo "<pre>Setup Modif By WILDY VPN</pre>" > /home/vps/public_html/index.html
wget -O /etc/nginx/conf.d/vps.conf "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/vps.conf"
/etc/init.d/nginx restart

# Menginstall badvpn dan Configurasi Badvpn Client dan IP IPnya
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/squidbaru.conf"
...
wget https://github.com/joenurul/wildyvpn.github.io/blob/main/script/ovpn.sh &&  chmod +x ovpn.sh && ./ovpn.sh
wget https://github.com/joenurul/wildyvpn.github.io/blob/main/script/wg.sh && chmod +x wg.sh && ./wg.sh
wget https://github.com/joenurul/wildyvpn.github.io/blob/main/script/ssr.sh && chmod +x ssr.sh && ./ssr.sh
...
cd /usr/bin
wget -O about "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/about.sh"
wget -O v2ray "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/menu.sh"
wget -O v2ray "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/ss.sh"
wget -O usernew "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/usernew.sh"
wget -O trial "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/trial.sh"
wget -O hapus "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/hapus.sh"
wget -O member "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/member.sh"
wget -O delete "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/delete.sh"
wget -O cek "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/cek.sh"
wget -O restart "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/restart.sh"
wget -O speedtest "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/speedtest.py"
wget -O info "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/info.sh"
wget -O ram "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/ram.sh"
wget -O renew "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/renew.sh"
wget -O v2ray "https://github.com/joenurul/wildyvpn.github.io/blob/main/script/v2ray.sh"
